...
const MENU_LIST = [
  ...
  [
    ...
    '订单管理',
    '/order',
    COMPONENT_EMPTY_PATH,
    {redirect: '/order/overview', iconClass: 'el-icon-sell'},
    [
  ...
  [
    ...
    '/logistics',
    COMPONENT_EMPTY_PATH,
    {redirect: '/logistics/overview', iconClass: 'el-icon-s-marketing'},
    [
      ...
      [
        ...
        'setting',
        COMPONENT_EMPTY_PATH,
        {redirect: '/logistics/setting/company', iconClass: 'el-icon-edit-outline'},
        [
  ...
  [
    ...
    '/commodity',
    COMPONENT_EMPTY_PATH,
    {redirect: '/commodity/overview', iconClass: 'el-icon-s-goods'},
    [
  ...
  [
    ...
    '/system-manage',
    COMPONENT_EMPTY_PATH,
    {redirect: '/system-manage/customer', iconClass: 'el-icon-setting'},
    [
